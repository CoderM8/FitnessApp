...
//
//     final mealsLIstbyCatIdModel = mealsLIstbyCatIdModelFromJson(jsonString);

import 'dart:convert';

MealsLIstbyCatIdModel mealsLIstbyCatIdModelFromJson(String str) => MealsLIstbyCatIdModel.fromJson(json.decode(str));

String mealsLIstbyCatIdModelToJson(MealsLIstbyCatIdModel data) => json.encode(data.toJson());

class MealsLIstbyCatIdModel {
  MealsLIstbyCatIdModel({
    required this.fitnessApp,
  });

  final List<FitnessApp> fitnessApp;

  factory MealsLIstbyCatIdModel.fromJson(Map<String, dynamic> json) => MealsLIstbyCatIdModel(
